...
C {vsource.sym} 710 -220 0 0 {name=V5 value="1.8" savecurrent=false}
...
C {sky130_fd_pr/corner.sym} 60 -270 0 0 {name=CORNER only_toplevel=true corner=ss}
C {code_shown.sym} 980 -380 0 0 {name="AC-SIM" only_toplevel=false value="
